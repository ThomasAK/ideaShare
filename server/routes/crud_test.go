...
func TestUsers(t *testing.T) {
	testutil.TestCrudEndpoints(t, "/user", func() *models.User {
		return &models.User{}
...
func TestUserSettings(t *testing.T) {
	testutil.TestCrudEndpoints(t, "/user/1/setting", func() *models.UserSetting {
...
func TestSiteSettings(t *testing.T) {
	testutil.TestCrudEndpoints(t, "/setting", func() *models.SiteSetting {
...
func TestIdeas(t *testing.T) {
	testutil.TestCrudEndpoints(t, "/idea", func() *models.Idea {
...
func TestComments(t *testing.T) {
	...
	testutil.TestCrudEndpoints(t, "/idea/1/comment", func() *models.IdeaComment {
...
func TestLikes(t *testing.T) {
	...
	testutil.TestCrudEndpointsWithoutAll(t, "/idea/1/like", func() *models.IdeaLike {
		return &models.IdeaLike{IdeaID: 1, UserID: 1}
	}, func(like *models.IdeaLike) {
		like.UserID = 1
		like.IdeaID = 1
	})
	testutil.TestReadAll[*models.IdeaLike](t, "/idea/1/like", func(count int) {
		for i := 1; i <= 20; i++ {
